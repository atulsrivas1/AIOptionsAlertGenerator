...
if __name__ == "__main__":
    ...
    try:
        with mlflow.start_run(run_name="Short-Term Strategy") as run:
            ...
            TRIPLE_BARRIER_PARAMS = {
                "profit_target": 0.027, # Adjusted for shorter horizon
                "stop_loss": 0.02, # Adjusted for shorter horizon
                "time_horizon": 2, # Short-term horizon
